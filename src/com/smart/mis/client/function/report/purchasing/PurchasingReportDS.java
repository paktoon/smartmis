...
public class PurchasingReportDS extends DataSource  {

	 private static PurchasingReportDS instance = null;
	 
	 public static PurchasingReportDS getInstance() {
		 if (instance == null) {
			 instance = new PurchasingReportDS();
		 }
		 return instance;
	 }
		 
		 public PurchasingReportDS(){ 
