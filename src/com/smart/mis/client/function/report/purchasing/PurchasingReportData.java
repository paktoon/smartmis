...
public class PurchasingReportData {
    ...
    public static ListGridRecord[] getNewRecords() {
    	...
    	for (int i = 1; i <= 6 ; i++) {
    		...
    		Double requested_amount = (Math.random() * 10000.0) + 1000;
    		...
    		dummyReport.add(createRecord("MRC30"+i , "PO23"+i, "MA20001","แมกกาไซต์ PP6", "แมกกาไซต์", "เม็ด", 5.00, Math.round((Math.random() * 10000.0) + 1000) * 1.0, date));
    		dummyReport.add(createRecord("MRC40"+i , "PO23"+i, "MA20002","แมกกาไซต์ PP7", "แมกกาไซต์", "เม็ด", 6.5, Math.round((Math.random() * 10000.0) + 1000) * 1.0, date));
    		dummyReport.add(createRecord("MRC50"+i , "PO23"+i, "MA20005","ถุงพลาสติก 6x6", "อื่นๆ", "ถุง" , 1.2, Math.round((Math.random() * 10000.0) + 1000) * 1.0, date));
    	}
