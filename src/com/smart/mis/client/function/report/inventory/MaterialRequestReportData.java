...
public class MaterialRequestReportData {
	public static ListGridRecord createRecord(String sub_request_id, String request_id, String material_id, String material_name, String material_unit, Double issued_amount, String material_type, Date issued_date) {  
    ...
    public static ListGridRecord[] getNewRecords() {
    	...
    	for (int i = 1; i <= 15 ; i++) {
    		...
    		dummyReport.add(createRecord("MRR50"+i , "MR23"+i, "MA20005","ถุงพลาสติก 6x6", "ถุง" , Math.round((Math.random() * 1000.0) + 1000) * 1.0, "อื่นๆ", date));
    	}
