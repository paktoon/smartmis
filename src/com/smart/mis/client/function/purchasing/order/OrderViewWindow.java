...
//		client = new Supplier();
	...
	private VLayout getViewEditor(final ListGridRecord record, boolean edit, final Window main, final User currentUser, int page) {
		...
		String order_id = record.getAttributeAsString("order_id");
...
//	        
//			final ListGridRecord orderRecord = PurchaseOrderData.createRecord(order_id, request_id, sid, sup_name, quote_id, payment_model, credit, null, null, delivery, total_weight, total_amount, total_netExclusive, new Date(), null, currentUser.getFirstName() + " " + currentUser.getLastName(), null, "", order_status, payment_status);
