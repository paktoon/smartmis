...
public class PurchaseOrderDS extends DataSource {

	 private static PurchaseOrderDS instance = null;
	 
	 public static PurchaseOrderDS getInstance() {
		 if (instance == null) {
			 instance = new PurchaseOrderDS();
		 }
		 
		 return instance;
	 }
	 
	 public static PurchaseOrderDS resetInstance() {
		 instance = new PurchaseOrderDS();
		 return instance;
	 }
