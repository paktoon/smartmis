...
public class MaterialData {
    ...
    public static ListGridRecord[] getNewRecords() {
    	return new ListGridRecord[]{ 
    			createRecord("MA10001","แร่เงิน 100%","แร่เงิน บริสุทธิ์ 100%", "แร่เงิน", "กรัม", null, 100000.0, 128302.9, 75000.0), //required
    			createRecord("MA10002","แร่เงิน 92.5%","แร่เงิน 92.5%", "แร่เงิน", "กรัม", null, 100000.0, 178392.9, 75000.0), //required
    			createRecord("MA20001","แมกกาไซต์ PP6","แมกกาไซต์  เบอร์ 6", "แมกกาไซต์", "เม็ด", 0.12, 1000.0, 2570.0, 200.0),
    			createRecord("MA20002","แมกกาไซต์ PP7","แมกกาไซต์  เบอร์ 7", "แมกกาไซต์", "เม็ด", 0.12, 1000.0, 2000.0, 180.0),
    			createRecord("MA20003","แมกกาไซต์ PP8","แมกกาไซต์  เบอร์ 8", "แมกกาไซต์", "เม็ด", 0.12, 1000.0, 2000.0, 720.0),
    			createRecord("MA20004","แมกกาไซต์ PP12","แมกกาไซต์  เบอร์ 12", "แมกกาไซต์", "เม็ด", 0.12, 1000.0, 1250.0, 100.0),
    			createRecord("MA20005","ถุงพลาสติก 6x6","ถุงพลาสติก ขนาด 6x6 ซม.", "อื่นๆ", "ถุง", 0.12, 1000.0, 5000.0, 3000.0),
    			
    			createRecord("MA20006","พลอย 1","พลอย 1", "พลอยประดับ", "เม็ด", 0.12, 0.0, 80.0, 0.0),
    			createRecord("MA20007","พลอย 2","พลอย 2", "พลอยประดับ", "เม็ด", 0.12, 0.0, 100.0, 0.0),
    			createRecord("MA20008","พลอย 3","พลอย 3", "พลอยประดับ", "เม็ด", 0.12, 0.0, 120.0, 0.0)
    	};
    }
