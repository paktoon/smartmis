...
//        searchItem.setUseTextField(true);
	...
	private VLayout createResult() {
		...
		reportListGrid.setDataSource(PurchaseRequestDS.getInstance());
		...
		reportListGrid.setFields(request_id, status, sid, sup_name, total_weight, total_amount, netInclusive);
