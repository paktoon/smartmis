...
public class ReportOrderLayout_1 extends VLayout{
	...
	public ReportOrderLayout_1(final User currentUser) {
...
//        searchItem.setUseTextField(true);
	...
	private VLayout createResult() {
		...
		reportListGrid.setDataSource(PurchaseOrderDS.getInstance());
		...
		reportListGrid.setFields(order_id, status, request_id, sid, sup_name, total_weight, total_amount, netInclusive);
