...
public class PlanTabSet extends TabSet {

	Boolean allowApproved;
	User currentUser;
	
	public PlanTabSet(Boolean allow, User user) {
		...
		PlanCreateTab createTab = new PlanCreateTab();
		PlanReviseTab reviseTab = new PlanReviseTab();
