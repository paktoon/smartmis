...
public class AbradingMaterialDS extends DataSource  {

		static HashMap<String, AbradingMaterialDS> instance = new HashMap<String, AbradingMaterialDS>();
		
		public static AbradingMaterialDS getInstance(String sub_job_id, String job_id){
			if (instance.containsKey(sub_job_id)) {
				...
				AbradingMaterialDS process = new AbradingMaterialDS(sub_job_id, job_id);
				instance.put(sub_job_id, process);
				return process;
			}
		}
		
		 public AbradingMaterialDS(String sub_job_id, String job_id){
			 //this.psid = psid;
			 //this.pid = pid;
			 ...
			 Field_2.setForeignKey("AbradingProductDS_"+job_id+".sub_job_id"); 
			 Field_2.setHidden(true);
			 
			 setFields(Field_1, Field_2, Field_3, Field_4, Field_5, Field_6);
			 //setDataURL("smartmis/security/userData");
			 setTestData(AbradingMaterialData.getNewRecords(sub_job_id)); // For Test
			 setClientOnly(true);
		 }
