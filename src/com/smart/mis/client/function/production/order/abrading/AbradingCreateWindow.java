...
public class AbradingCreateWindow {
...
//		dateForm.setFields(fromDate, toDate, deliveryDate);
		...
		final IButton printButton = new IButton("ออกคำสั่งขัดและติดพลอยแมกกาไซต์");
		printButton.setIcon("icons/16/print.png");
		printButton.setWidth(220);
...
//			System.out.println("--- " + item.request_amount);
		...
		ListGridRecord newRecord = MaterialRequestData.createRecord(request_id, job_id, smith, "3_abrade", new Date(), total_request_amount, new Date(), null, user, null, "1_requested");
