...
public class AbradingDS extends DataSource {

	 private static AbradingDS instance = null;
	 
	 public static AbradingDS getInstance() {
		 if (instance == null) {
			 instance = new AbradingDS();
		 }
		 
		 return instance;
	 }
	 
	 public static AbradingDS resetInstance() {
		 instance = new AbradingDS();
		 return instance;
	 }
	 ...
	 public AbradingDS(){
		 ...
		 setTestData(AbradingData.getNewRecords()); // For Test
		 setClientOnly(true);
	 }
