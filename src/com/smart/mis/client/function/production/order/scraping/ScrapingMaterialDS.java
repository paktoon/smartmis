...
public class ScrapingMaterialDS extends DataSource  {

		static HashMap<String, ScrapingMaterialDS> instance = new HashMap<String, ScrapingMaterialDS>();
		
		public static ScrapingMaterialDS getInstance(String sub_job_id, String job_id){
			if (instance.containsKey(sub_job_id)) {
				...
				ScrapingMaterialDS process = new ScrapingMaterialDS(sub_job_id, job_id);
				instance.put(sub_job_id, process);
				return process;
			}
		}
		
		 public ScrapingMaterialDS(String sub_job_id, String job_id){
			 //this.psid = psid;
			 //this.pid = pid;
			 ...
			 Field_2.setForeignKey("ScrapingProductDS_"+job_id+".sub_job_id"); 
			 Field_2.setHidden(true);
			 
			 setFields(Field_1, Field_2, Field_3, Field_4, Field_5, Field_6);
			 //setDataURL("smartmis/security/userData");
			 setTestData(ScrapingMaterialData.getNewRecords(sub_job_id)); // For Test
			 setClientOnly(true);
		 }
		 
		 public ScrapingMaterialDS(){
			 DataSourceTextField Field_3 = new DataSourceTextField("mid", "รหัสวัตถุดิบ");
			 DataSourceTextField Field_4 = new DataSourceTextField("mat_name", "ชื่อวัตถุดิบ");
			 DataSourceFloatField Field_5 = new DataSourceFloatField("produce_amount", "ปริมาณที่ใช้ผลิต");
			 DataSourceTextField Field_6 = new DataSourceTextField("unit", "หน่วย");
