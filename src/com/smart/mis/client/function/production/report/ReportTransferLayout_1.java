...
public class ReportTransferLayout_1 extends VLayout{
	...
	public ReportTransferLayout_1(final User currentUser) {
...
//        searchItem.setUseTextField(true);
	...
	private VLayout createResult() {
		...
		reportListGrid.setDataSource(TransferDS.getInstance());
...
//		netInclusive.setShowGridSummary(true);
		...
		reportListGrid.setFields(transfer_id, status, plan_id, transfer_by, total_weight, total_amount);
