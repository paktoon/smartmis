...
//        record.setAttribute("thickness", product.getAttributeAsDouble("thickness")); //mm
    ...
    public static ListGridRecord[] getNewRecords() {
    	return new ListGridRecord[]{ 
    			...
    			createDummyRecord("PD10003","Dense plain silver ring", "แหวนเงินเกลี้ยง แบบหนา", 6.8, 62.0, "ring", 0 , 0, "http://lh4.ggpht.com/eUlY9K1Zedw858kxmkx6g_Atcx8STAm3RbYLcBHMDIx8KwLRWSlwA0YGvbRsDPoodbP9y0mqe8BpeBgZDlgsilEM", 5.0,null,null,null,null,4.0, false),
    			//GWT.getHostPageBaseURL() + "_ah/img/_avEWP6JsPhjg9w8eS2rmg"																																					Double size, Double width, Double length, Double height, Double diameter, Double thickness															
    			createDummyRecord("PD10004","Spiral silver earrings", "ต่างหู ตีเกลียวคู่", 6.32, 55.0, "earring", 250, 0, "http://lh3.ggpht.com/QA3XN4rm-YUJa5cYTDrlSTmltS78CUc-c7bQWxFhiilZu130TXLeT6QtJ6Z_A4HnJmLEZcPEKnuiqDll5fggkwOj", null, null, null, 0.7, 2.6, 3.0, true),
    			...
    			createDummyRecord("PD10006","Silver necklace with star pendant", "สร้อยคอ พร้อมจี้รูปดาว", 6.32, 55.0, "necklace" , 100, 0, "http://lh4.ggpht.com/9mW7YapodtKfhcJQwIAXvHRulEmU0LP0CEVsICh8Ykijw-yIV5UvqfHp03zlubSDSUu0K4T7FcPSb5n5C4ggby0", null, 25.0, 45.5, null, null, 3.0, false),
    			createDummyRecord("PD10007","Plain silver necklaces", "สายสร้อย โซ่คร้อง", 6.32, 50.0, "necklace", 100, 0, "http://lh3.ggpht.com/3MowBFjEbea2M1eVBBoM1q1LC_t-mvjmBDcDMDxnMnnOR7PFOvQ4dfLUKPNSYHam9VvwzAhr5ULzjFbKtUMkdQ", null, 25.0, 50.0, null, null, 3.0, false),
    			...
    			createDummyRecord("PD10011","Spiral pendant", "จี้ ตีเกลียวคู่", 6.32, 55.0, "pendant", 100, 0, "http://lh3.ggpht.com/kR6VmXML7n9PZ7PxLw9BJ8FROHjGBGacMvXIu2lBYOIFK5hk4MozyDYGKA_QMF7pJQ0oQQktfflY5QrrIsQaxds", null, null, null, 0.7, 2.6, 3.0, false),
    			createDummyRecord("PD10012","Scorpion pendant", "จี้ ลงดำ ลายแมงป่อง", 6.32, 50.0, "pendant", 100, 50, "http://lh5.ggpht.com/ZRAXpCSF4r34-xksmN1B2TkhFUu11GJjwnDjqHHiuqm00b18VMuH_3reOpbeW19JV-GV539m8CQ_-4Hop3yCQTs", null, null, null, 7.0, 10.0, 3.0, true),
    			
    			createDummyRecord("PD10013","Spiral bracelet", "กำไลข้อมือ ตีเกลียวคู่", 6.32, 55.0, "bracelet", 150, 0, "http://lh4.ggpht.com/uBtxtIxrBpBIm50rf3T30lNDihTwOLnWkCZaCtu1nwQ7tzFGoE3pzyzfEnR4nLVq2cRyBFssmZCA3WC3jKXlD-k", null, null, null, 0.7, 2.6, 3.0, false),
    			...
    			createDummyRecord("PD10015","Plain silver bangle", "สร้อยข้อเท้า ธรรมดา", 6.32, 50.0, "bangle", 75, 0, "http://lh5.ggpht.com/odtKYjc-2oxEzapmNHo9zLEymSr6mzyGYJ-T6uX7oQ0CapusDZg9C2ilX5VlMgzdIFaQf24SJIJa0hzNevljSfo", null, 12.5, 25.0, null, null, 3.0, true),	
    	};
    }
