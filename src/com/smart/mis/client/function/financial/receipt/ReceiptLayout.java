package com.smart.mis.client.function.financial.receipt;
...
public class ReceiptLayout extends VLayout {
	
	public ReceiptLayout(final User currentUser){
...
//		});
		...
		ListGridField iconField = new ListGridField("receiptInvoiceField", "เรียกดู/ทำรายการ", 100);
