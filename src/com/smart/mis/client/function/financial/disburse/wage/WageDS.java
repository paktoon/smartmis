...
public class WageDS extends DataSource {

	 private static WageDS instance = null;
	 
	 public static WageDS getInstance() {
		 if (instance == null) {
			 instance = new WageDS();
		 }
	 ...
	 public static WageDS resetInstance() {
		 instance = new WageDS();
		 return instance;
	 }
	 ...
	 public WageDS(){
		 setID("WageDS");
		 DataSourceTextField Field_1 = new DataSourceTextField("wage_id", "รหัสค่าจ้างผลิต");
...
//		 DataSourceTextField Field_11 = new DataSourceTextField("comment", "ความคิดเห็น");
		 ...
		 Field_12.setValueMap(WagePaymentStatus.getValueMap());
		 
		 DataSourceFloatField Field_13 = new DataSourceFloatField("paidInclusive", "ยอดเงินที่ชำระ (บาท)");
		 DataSourceDateField Field_14 = new DataSourceDateField("paid_date", "วันที่ชำระเงิน");
		 DataSourceTextField Field_15 = new DataSourceTextField("paid_by", "ชำระเงินโดย");
...
//		 setFields(Field_1, Field_2, Field_3_1, Field_3_2, Field_3_3, Field_3_4, Field_3_5, Field_3_6, Field_3_7, Field_4_1, Field_4_2, Field_4_3 ,Field_5, Field_6, Field_6_1, Field_6_2, Field_6_3,  Field_7, Field_8, Field_9, Field_10, Field_11, Field_12);
		 setFields(Field_1, Field_2, Field_3_1, Field_3_2, Field_3_3, Field_3_4, Field_3_5, Field_3_6, Field_3_7, Field_6_1, Field_6_2, Field_6_3,  Field_7, Field_8, Field_9, Field_10, Field_12, Field_13, Field_14, Field_15);
		 
		 //setDataURL("smartmis/security/userData");
		 setTestData(WageData.getNewRecords()); // For Test
		 setClientOnly(true);
	 }
