...
public class QuotationData {
    ...
    public static ListGridRecord[] getNewRecords() {
    	return new ListGridRecord[]{ 
    			createRecord("QA10001","CU10017", "Flora Creek", new Date(), new Date(), new Date() , 120.0, 70, 11000.0, new Date(), null, "admin test", null, "", "รออนุมัติ"),
    			createRecord("QA10002","CU10008", "ประทีปเจมส์", new Date(), new Date(), new Date() , 120.0, 70, 14850.0, new Date(), null, "admin test", null, "", "รอแก้ไข"),
    			createRecord("QA10003","CU10004", "มายด์ แอนด์ ลีน่าเครื่องประดับ", new Date(), new Date(), new Date() , 120.0, 70, 350.0, new Date(), null, "admin test", null, "", "ยกเลิก"),
    			createRecord("QA10004","CU10010", "บริษัท บิ๊กซิลเวอร์ แมนูแฟคเจอร์ริ่ง จำกัด", new Date(), new Date(), new Date() , 120.0, 70, 5000.0, new Date(), null, "admin test", null, "", "อนุมัติแล้ว")
    	};
    	//return new ListGridRecord[]{};
    }
}
