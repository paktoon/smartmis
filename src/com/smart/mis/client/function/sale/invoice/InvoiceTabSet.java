...
public class InvoiceTabSet extends TabSet {

	//Boolean allowApproved;
	User currentUser;
	
	public InvoiceTabSet(User user) {
		...
		InvoiceReviewTab reviewTab = new InvoiceReviewTab();
		addTab(reviewTab.getReviewTab(user));
	}
}
