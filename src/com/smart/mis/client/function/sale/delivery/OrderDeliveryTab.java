...
/*		final TextItem cnameText = new TextItem("cus_name", "ชื่อลูกค้า");
		...
		final ListGrid deliveryListGrid = new EditorListGrid(new DeliveryViewWindow(), currentUser);
		...
		deliveryListGrid.setGroupByField("status");
...
//		});
		...
		deliveryListGrid.setFields(status, delivery_id, sale_id, cus_name, total_amount, delivery_date, iconField);
...
//			            		deliveryListGrid.updateData(selected);
//			            		deliveryListGrid.removeSelectedData(new DSCallback() {
//									@Override
