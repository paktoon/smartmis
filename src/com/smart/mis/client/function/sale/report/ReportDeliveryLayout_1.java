...
public class ReportDeliveryLayout_1 extends VLayout{
	...
	public ReportDeliveryLayout_1(final User currentUser) {
...
//        searchItem.setUseTextField(true);
	...
	private VLayout createResult() {
		...
		reportListGrid.setDataSource(DeliveryDS.getInstance());
...
//		netInclusive.setShowGridSummary(true);
		...
		reportListGrid.setFields(delivery_id, status, sale_id, cid, cus_name, total_weight, total_amount);
