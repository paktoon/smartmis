...
public class ReportInvoiceLayout_1 extends VLayout{
	...
	public ReportInvoiceLayout_1(final User currentUser) {
...
//        searchItem.setUseTextField(true);
        ...
        text.setContents("รายงานการแจ้งหนี้");
	...
	private VLayout createResult() {
		...
		reportListGrid.setFields(invoice_id, status, sale_id, cid, cus_name, total_weight, total_amount, netInclusive);
