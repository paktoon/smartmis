...
public class ReportSaleOrderLayout_1 extends VLayout{
	...
	public ReportSaleOrderLayout_1(final User currentUser) {
...
//        searchItem.setUseTextField(true);
	...
	private VLayout createResult() {
		...
		reportListGrid.setDataSource(SaleOrderDS.getInstance());
		...
		reportListGrid.setFields(sale_id, status, cid, cus_name, total_weight, total_amount, netInclusive);
