...
public class ReportQuotationLayout extends VLayout {
	...
	public ReportQuotationLayout(final User currentUser){
		...
		quoteListGrid.setFields(created_date, quote_id, status,  cid, cus_name, total_weight, total_amount, netInclusive);
		...
		IButton searchButton = new IButton("ออกรายงานใบเสนอราคา");
