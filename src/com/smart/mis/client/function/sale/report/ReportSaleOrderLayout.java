...
public class ReportSaleOrderLayout extends VLayout {
	
	Label reportDate;
	
	public ReportSaleOrderLayout (final User currentUser){
...
//		saleText.setOperator(OperatorId.REGEXP);
		...
		sale_id.setSummaryFunction(new SummaryFunction() {  
            public Object getSummaryValue(Record[] records, ListGridField field) {
                return records.length + " รายการ";  
            }  
        });  
		sale_id.setShowGridSummary(true);
		...
		saleListGrid.setFields(created_date, sale_id, status, cid, cus_name, total_weight, total_amount, netInclusive);
		...
		IButton searchButton = new IButton("ออกรายงานการขาย");
