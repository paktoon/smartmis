...
public class MaterialUsedColumnChart {
...
//		    options.setIsStacked(true);
		    ...
		    options.setVAxisOptions(createAxisOption("ปริมาณการใช้วัตถุดิบ (หน่วย)"));
		    options.setTitle("รายงานสรุปยอดการใช้วัตถุดิบ");
...
//		    options.setChartArea(area);
	  ...
	  private SelectHandler createSelectHandler(final ColumnChart chart, final ReportPanel panel) {
		  ...
		  private AbstractDataTable createTable() {
		    ...
		    data.addColumn(ColumnType.NUMBER, "ปริมาณวัตถุดิบที่เบิกจ่าย (หน่วย)"); //1
