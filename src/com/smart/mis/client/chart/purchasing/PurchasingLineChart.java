package com.smart.mis.client.chart.purchasing;
...
public class PurchasingLineChart {

	public void loadChart(final Canvas loader, final ReportPanel panel, final String type) {  
	    Runnable onLoadCallback = new Runnable() {
	        public void run() {
	   
	          LineChart chart = new LineChart(createTable(type), createOptions());
	  ...
	  private Options createOptions() {
		    ...
		    options.setVAxisOptions(createAxisOption("ยอดสั่งซื้อ(บาท)"));
...
//		    groupWidthOption.set("groupWidth", "50%");
	  ...
	  private SelectHandler createSelectHandler(final LineChart chart, final ReportPanel panel) {
